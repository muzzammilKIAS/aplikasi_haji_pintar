        ...
        build: (pw.Context context) {
          return pw.Stack(
            children: <pw.Widget>[
              ...
              // Tarikh — text-anchor start (Tiada tolakan paksa)
              pw.Positioned(
                top: CertificateCoordinates.dateY * scaleY - CertificateCoordinates.dateFontSize * scaleY * 0.4,
              ...
              // Nombor sijil — text-anchor start (Tiada tolakan paksa)
              pw.Positioned(
                top: CertificateCoordinates.certificateNumberY * scaleY - CertificateCoordinates.certificateNumberFontSize * scaleY * 0.4,
            ...
            builder: (BuildContext context, BoxConstraints constraints) {
              ...
              return Stack(
                ...
                children: <Widget>[
                  ...
                  // Tarikh — dibetulkan 100% tanpa sebarang tolakan paksa
                  Positioned(
                    left: width * CertificateCoordinates.dateX / CertificateCoordinates.templateWidth,
                    top: height * CertificateCoordinates.dateY / CertificateCoordinates.templateHeight - CertificateCoordinates.dateFontSize / 2,
                    child: Text(
                      date,
                  ...
                  // Nombor sijil — dibetulkan 100% tanpa sebarang tolakan paksa
                  Positioned(
                    left: width * CertificateCoordinates.certificateNumberX / CertificateCoordinates.templateWidth,
                    top: height * CertificateCoordinates.certificateNumberY / CertificateCoordinates.templateHeight - CertificateCoordinates.certificateNumberFontSize / 2,
                    child: Text(
                      certificateNumber,
                      textAlign: TextAlign.left,
                      style: const TextStyle(
                        fontFamily: CertificateCoordinates.certificateNumberFontFamily,
                        fontSize: CertificateCoordinates.certificateNumberFontSize,
