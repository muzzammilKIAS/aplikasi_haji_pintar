...
class CertificateCoordinates {
  ...
  // Tahap pencapaian — Dikembalikan kepada kedudukan ASAL yang sempurna
  ...
  // Tarikh — Bermula tepat pada pangkal garisan selepas label
  static const double dateX = 570.0;
  ...
  // Nombor sijil — Bermula tepat pada pangkal garisan selepas label
  static const double certificateNumberX = 930.0;
